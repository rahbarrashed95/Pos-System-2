...
<section class="content-header no-print">
    ...
    <h1>Customer Wise Sale Report</h1>
</section>
...
<section class="content no-print">
	<div class="box">
                ...
                @if( $contact->type == 'supplier' ||  $contact->type == 'customer' || $contact->type == 'both')
                    ...
                    <div class="col-sm-12">
                        @if(($contact->total_purchase - $contact->purchase_paid) > 0 || ($contact->total_sell - $contact->sell_paid) > 0)
                            <a href="{{action('TransactionPaymentController@getPayContactDue', [$contact->id])}}?type={{$contact->t_type}}" class="pay_purchase_due btn btn-primary btn-sm pull-right"><i class="fa fa-money" aria-hidden="true"></i> @lang("contact.pay_due_amount")</a>
                        @endif
                     
                            <a href="{{action('TransactionPaymentController@getAddAdvance', [$contact->id])}}" class="pay_purchase_due btn btn-primary btn-sm pull-right"><i class="fa fa-money" aria-hidden="true"></i> Add Advance</a>
        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <h4 style="background: #0080A7;font-weight: 600;color: #fff;padding: 5px;">To</h4>
                ...
                <div class="col-sm-6" style="margin-left: 25%;">
                     <h4 style="background: #0080A7;font-weight: 600;color: #fff;padding: 5px;">Account Summary</h4>
                    @if( $contact->type == 'supplier' || $contact->type == 'both')
                        <strong>@lang('report.total_purchase')</strong>
                        <p class="text-muted">
                        <span class="display_currency" data-currency_symbol="true">
                    ...
                    <table class="table table-bordered table-striped">
                            <tbody>
                                <tr>
                                    <th><strong>@lang('report.total_sell')</strong></th>
                                    <th><span class="display_currency" data-currency_symbol="true">
                                        {{ $contact->total_invoice }}</span>
                                    </th>
                                </tr>
                                <tr>
                                    <th><strong>@lang('contact.total_sale_paid')</strong></th>
                                    <th>
                                        <span class="display_currency" data-currency_symbol="true">
                                        {{ $contact->invoice_received }}</span>
                                    </th>
                                ...
                                <tr>
                                    <th><strong>@lang('contact.total_sale_due')</strong></th>
                                    <th>
                                        <span class="display_currency" data-currency_symbol="true">
                        {{ $contact->total_invoice - $contact->invoice_received }}</span>
                                    </th>
                        ...
                        {{ $contact->balance}}</span>
                                ...
                                <tr>
                                    <th><strong>@lang('lang_v1.opening_balance')</strong></th>
                                    <th>
                                        <span class="display_currency" data-currency_symbol="true">
                        {{ $contact->opening_balance }}</span>
                                    </th>
...
$(document).ready( function(){
    ...
    let url='/sells?customer_id={{ $contact->id }}';
    ...
    $.ajax({
        ...
        success:function(res){
            $('tbody#sell_tbody').html(res.data);
            console.log(res);
        }
    });
