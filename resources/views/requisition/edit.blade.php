...
<section class="content">
  ...
  @include('layouts.partials.error')
   ...
   {!! Form::open(['url' =>  action('RequisitionController@update' , [$purchase->id] ), 'method' => 'PUT', 'id' => 'add_purchase_form', 'files' => true ]) !!}

  <input type="hidden" name="user_id" value="{{ $purchase->created_by }}">
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::select('location_id', $business_locations, $purchase->location_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
          </div>
        </div>
  ...
  <div class="box box-solid"><!--box start-->
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-sm-12">
          @include('requisition.partials.edit_purchase_entry_row')
  ...
  <div class="box box-solid"><!--box start-->
    ...
    @include('requisition.partials.payment_row', ['row_index' => 0])
      <hr>
      <div class="row">
        <div class="col-sm-12">
          <div class="pull-right"><strong>@lang('purchase.payment_due'):</strong> <span id="payment_due">@num_format($purchase->final_amount-$purchase->payment_amount)</span></div>
        </div>
      </div>
      <br>
    </div>
  ...
  <div class="row">
    <div class="col-sm-12">
      <button type="button" id="submit_purchase_form" class="btn btn-primary pull-right btn-flat">Purchase Approve</button>
    </div>
  </div>
{!! Form::close() !!}
</section>
