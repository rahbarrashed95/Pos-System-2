...
<div class="table-responsive">
    ...
    id="purchase_entry_table">
        ...
        <tbody>
    <?php $row_count = 0; ?>
    @foreach($purchase->details as $purchase_line)
        <tr>
            ...
            <td>
                {!! Form::hidden('purchases[' . $loop->index . '][tax_id]', $purchase_line->tax_id ); !!}
                {!! Form::hidden('purchases[' . $loop->index . '][item_tax]', $purchase_line->item_tax ); !!}
