@extends('layouts.app')
@section('title', __( 'Customer Wise Sell Report'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>Customer Wise @lang( 'sale.sells') Report
        <small></small>
    </h1>
</section>
...
<section class="content no-print">
	<div class="box">
        <div class="box-header">
        	...
        	<h3 class="box-title">Customer Wise Sale Report</h3>
            @can('sell.create')
            	<div class="box-tools">
...
$(document).ready( function(){
    ...
    sell_table = $('#due_sell_table').DataTable({
        ...
        aaSorting: [[0, 'desc']],
        "ajax": {
            "url": "/reports/customer-wise-sell-report",
            "data": function ( d ) {
