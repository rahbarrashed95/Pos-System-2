			...
			<div class="box box-success">
				...
				<div class="box-header with-border col-12">
					<div class="row">
						...
						<div class=" col-sm-4">
							<a class="btn btn-success btn-sm pull-right box-tools" href="{{action('SellPosController@create')}}">
				...
				<div class="box-body">
					<div class="row">
						...
						<div class="col-md-4 col-sm-6">
							<div class="form-group">
								...
								<div class="input-group">
									...
									{!! Form::text('transaction_date', old('transaction_date', date('d/m/Y h:i A', strtotime($transaction->transaction_date))) ,['class' => 'form-control', 'readonly', 'required']); !!}
								</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-6">
							<div class="form-group" style="margin-bottom: 0px;">
								...
								<div class="input-group">	
									...
									<select id="sr_id" name="sr_id" class="form-control">
										...
										<option {{ old('sr_id', $transaction->sr_id ) == $sells_representative->id ? 'selected' : '' }}  value="{{ $sells_representative->id }}">{{ $sells_representative->name }}</option>
										@endforeach
									</select>
									<span class="input-group-addon">
										@show_tooltip('Selling Sr Name')
									</span> 
								</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-6">
							<div class="form-group" style="margin-bottom: 0px;">
								<label for="delivery_man_id">Delivery Man Name</label>
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-briefcase"></i>
									</span>
									<select id="delivery_man_id" name="delivery_man" class="form-control">
										...
										<option {{ old('delivery_man', $transaction->delivery_man_id ) == $delivery_man->id ? 'selected' : '' }}  value="{{ $delivery_man->id }}">{{ $delivery_man->name }}</option>
										@endforeach
									</select>
									<span class="input-group-addon">
										@show_tooltip('Selling Delivery Name')
									</span> 
								</div>
							</div>
						</div>
						...
						<div class="col-sm-3">
							<div class="form-group"style="margin-bottom: 0px;">
								<div class="input-group">
									...
									<input id="unit_select_id" name="invoice_no" class="form-control" placeholder="Inovice Number" value="{{ old('invoice_no', $transaction->invoice_no ) }}" />
									<span class="input-group-addon">
