		...
		<div class="panel panel-default">
			<div class="panel-body bg-gray disabled" style="margin-bottom: 0px !important">
				<table class="table table-condensed" 
					...
					<tr>
						<td>
						    	<div class="col-sm-12 col-xs-12 d-inline-table">
								<b>@lang('Discount Person Name'):</b> 
								<br/>
							    <input type="text" class="form-control" name="discount_person">
							</div>
							...
							<div class="col-sm-2 col-xs-6 d-inline-table"  style="display">
					...
					<tr>
						<td>
							{{-- <div class="col-sm-1 col-xs-2 col-2px-padding"></div> --}}
