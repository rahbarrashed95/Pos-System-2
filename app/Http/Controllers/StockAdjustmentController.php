...
class StockAdjustmentController extends Controller
{
        ...
        try {
            ...
            if (!empty($products)) {
                ...
                foreach ($products as $product) {
                    ...
                    $unit = 'pc';
                    if($request->input('adjustment_type') == 'Excess'){    
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $stock_adjustment = Transaction::find($request['transaction_id']);
            $stock_adjustment ->update($input_data);
            $stock_adjustment->stock_adjustment_lines()->updateOr($product_data);
