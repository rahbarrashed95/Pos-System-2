                            ...
                            foreach ($rows as $key => $v) {
                                ...
                                if ($qty > 0) {
                                    ...
                                    if (isset($v['purchase_line_id'])) {
                                        ...
                                        $this->productUtil->updateProductQuantity($location_id,'pc', $product->id, $k, $qty_formated, $old_qty);
                                    } else {
                                        ...
                                        $this->productUtil->updateProductQuantity($location_id, 'pc', $product->id, $k, $qty_formated);
                                    }
